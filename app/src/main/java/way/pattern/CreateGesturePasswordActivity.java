...
import way.view.LockPatternView;
import way.view.LockPatternView.Cell;
import way.view.LockPatternView.DisplayMode;
...
public class CreateGesturePasswordActivity extends Activity implements
	...
	private void saveChosenPatternAndFinish() {
        ...
        LockPasswordUtils temp=new LockPasswordUtils(App.getInstance());
        String str= mChosenPattern.toString();
        temp.saveLockPassword(str,0,true);
		showToast("密码设置成功");
